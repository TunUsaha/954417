...
<body class="backgroud-overlay">
    <div class="container_userInfo mt-5 ">
        <h2 class="userInfo_heading">ข้อมูลผู้ใช้</h2>
        ...
        <?php if ($user): ?>
            <div class="userInfo_card">
                <div class="card-body">
                    ...
                    <a href="display_repair_request.php" class="btn btn-primary userInfo_btn">Back</a>
                </div>
            </div>
        <?php else: ?>
            <p class="userInfo_no-data">ไม่พบข้อมูลผู้ใช้</p>
        <?php endif; ?>
    </div>
